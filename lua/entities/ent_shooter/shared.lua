...
ENT.PrintName = "Shooter cube (up)" -- The name that will appear in the spawn menu.
ENT.Purpose = "On Use spawns vertically explosive barrels, with 0.1 delay which explodes after 3 seconds"
