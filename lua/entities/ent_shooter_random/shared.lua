...
ENT.PrintName = "Shooter cube (random)" -- The name that will appear in the spawn menu.
ENT.Purpose = "On Use spawns in random direction of it explosive barrels, with 0.1 delay which explodes after 3 seconds"
